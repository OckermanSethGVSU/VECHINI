...
LOCAL_QDRANT_VERSION="${QDRANT_VERSION:-latest}"
if [[ "$LOCAL_QDRANT_VERSION" != "latest" && "$LOCAL_QDRANT_VERSION" != v* ]]; then
    LOCAL_QDRANT_VERSION="v$LOCAL_QDRANT_VERSION"
fi
IMAGE="${QDRANT_LOCAL_IMAGE:-qdrant/qdrant:${LOCAL_QDRANT_VERSION}}"
