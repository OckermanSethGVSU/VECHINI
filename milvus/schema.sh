...
register_milvus_var "PERF" "default" "NONE" "NONE STAT RECORD" "Performance collection mode"
register_milvus_var "PERF_EVENTS" "default" "cycles,instructions,topdown-be-bound,topdown-mem-bound,topdown-retiring" "" "Comma-separated perf stat events"
